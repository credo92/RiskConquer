...
public class MapFileParserTest {
	 ...
	 * @throws IOException that checks any IO Exception
	 */
	@Before
	 ...
	 * @throws InvalidMapException exception that checks whether map is invalid or not
	 */
	@Test
